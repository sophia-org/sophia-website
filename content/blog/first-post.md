...
*   **Confinement via Namespaces:** Instead of a single shared environment, Sophia introduces virtualized, isolated domains. Cross-namespace lookups fail closed by default. A web browser running in one namespace cannot inspect or interact with a terminal running in another.
